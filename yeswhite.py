    ...
    with ThreadPoolExecutor(max_workers=len(authorizations)) as executor:
        ...
        for future in futures:
            ...
            if result:
                ...
                if "YesWhite Akun-" in clean_result and " | " in clean_result:
                    try:
                        ...
                        print(Fore.RED + "Error parsing account index from result: " + clean_result)
                else:
                    print(Fore.RED + "Unexpected result format: " + clean_result)
